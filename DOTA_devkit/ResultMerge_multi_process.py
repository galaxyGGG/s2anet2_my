...
if __name__ == '__main__':
    ...
    # mergebypoly("/home/jyc/下载/s2anet/work_dirs/ganlan/txt","/home/jyc/下载/s2anet/work_dirs/ganlan/txt_merged")
    # bypoly用于task1，byrec用于task2
    mergebypoly(r'/data/res/s2anet_r50_fpn_1x/results_before_nms', r'/data/res/s2anet_r50_fpn_1x/raw_before_nms')
